                    ...
                    <p>Atualize suas infromações abaixo</p>
                        <form accept-charset="ISO-8859-1" name="FEntrada" action="ControleAdmin" method="POST" class="form">
                            ...
                            <div class="input-imagem">
                                ...
                                <% } else { %>
                                    <input type="text" name="campoImagem" id="campoImagem" placeholder="Link da sua imagem de perfil" value="<%= admin.getImagem() %>">
                                <% }%>
                               
                            </div>
                            </div>
                            <input type="text" name="campoNome" placeholder="Nome" value="<%= admin.getNome() %>">
                            <input type="text" name="campoUsuario" placeholder="Usuário" value="<%= admin.getUsuario() %>">
                            <input type="text" name="campoEmail" id="campoEmail" placeholder="Email" value="<%= admin.getEmail() %>">
